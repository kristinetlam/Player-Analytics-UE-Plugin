      ...
      >
        <DashboardContent pathname={router.pathname} sx={{ backgroundColor: '#f7f7f7' }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            <CardComponent title="Average FPS" infoContent="Displays the average FPS across all player sessions. If no date range is selected, data from the past 30 days is used by default. Each player’s FPS is averaged per session and then aggregated into an overall average. The percentage shows the change compared to the previous 30-day period."
                 sx={{ flex: '1 1 300px', maxWidth: '300px', minWidth: '300px', minHeight: '200px', maxHeight: '300px', display: 'flex', flexDirection: 'column' }} moveTitleUp={true} marginBottom={false} centerContent={true} fixed={true}><AverageFPS filter={filter} /></CardComponent>
            <CardComponent title="Average Load" infoContent="A gauge that displays the average usage in CPU or RAM, to a maximum of 100% and 16 GB respectively." sx={{ flex: '1 1 300px', maxWidth: '300px', minWidth: '300px', maxHeight: '400px', display: 'flex', flexDirection: 'column' }} moveTitleUp={true} marginBottom={false} centerContent={true} fixed={true}><Box sx={{ mt: '-40px' }}><LoadGauge filter={filter}/></Box></CardComponent>
            <CardComponent title="Return Rate" infoContent="Represents the average number of return sessions per player after their first session, indicating how often players come back to play again. Calculated as (total sessions - total unique players) ÷ total players. If a specific player is selected, it shows how many times that player returned. This defaults to the past 30 days unless a date range is selected." sx={{ flex: '1 1 300px', maxWidth: '300px', minWidth: '300px', maxHeight: '300px', display: 'flex', flexDirection: 'column' }} moveTitleUp={true} marginBottom={false} centerContent={true} fixed={true}><Box sx={{ mt: '-40px' }}><GaugeChartComp filter={filter}/></Box></CardComponent>
            <CardComponent title="Average Session Length" infoContent="A calcuation showing the average session length across all player sessions over the past 30 days. Each player’s session length is recorded when a session ends." sx={{ flex: '1 1 300px', maxWidth: '300px', minWidth: '300px', minHeight: '240px', maxHeight: '300px', display: 'flex', flexDirection: 'column' }} moveTitleUp={true} marginBottom={false} centerContent={true} fixed={true}><AverageSessionLength filter={filter} /></CardComponent>
            ...
            <CardComponent title="Heatmap" infoContent="Visualizes player X and Y positions across the game map. Data can be analyzed by Seconds Elapsed, FPS, CPU Usage, or RAM Usage. The bin size selector on the right adjusts the map's grid resolution to control the level of detail. Results can also be filtered by GPU in the global filter."
                description="Visualizes selected values averaged across the game map."  sx={{ flex: '1 1 600px', maxWidth: '700px', minWidth: '400px', minHeight: '380px'}} centerContent={false}><Heatmap filter={filter} /></CardComponent>

      ...
      <DashboardLayout slots={{ toolbarActions: () => <ToolbarActions setOpenFilter={setOpenFilter} /> }}>
        <DashboardContent pathname={router.pathname} sx={{ backgroundColor: '#f7f7f7' }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <CardComponent title="Player Session Statistics" description="Summarizes player session data with key metrics"  sx={{ flex: '1 1 600px', maxWidth: '600px', minWidth: '400px', minHeight: '330px', maxHeight: '400px' }} centerContent><PlayerSessionStats filter={filter} /></CardComponent>
            ...
            <CardComponent title="Average FPS Timeline" description="Player FPS averages grouped by day over time" sx={{ flex: '1 1 600px', maxWidth: '600px', minWidth: '400px', minHeight: '330px', maxHeight: '450px' }} centerContent><FPSLineChart filter={filter} /></CardComponent>
            <CardComponent title="Player Location" description="Visualizes player movement density across the game map" sx={{ minHeight: '500px', maxHeight: '600px', minWidth: '800px', maxWidth: '1000px'}} centerContent={false}><ApexChart filter={filter} /></CardComponent>

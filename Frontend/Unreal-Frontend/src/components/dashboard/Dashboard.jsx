      ...
      <DashboardLayout slots={{ toolbarActions: () => <ToolbarActions setOpenFilter={setOpenFilter} /> }}>
        <DashboardContent pathname={router.pathname} sx={{ backgroundColor: '#f7f7f7' }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <CardComponent title="Computer Usage Heatmap" infoContent="sadsd" description="Visualizes average RAM/CPU usage across the game map"  sx={{ flex: '1 1 600px', maxWidth: '700px', minWidth: '400px', minHeight: '380px'}} centerContent={false}><Heatmap filter={filter} /></CardComponent>
            <CardComponent title="Player Location" infoContent="sadsd" description="Visualizes player location across the game map" sx={{ width: '65%'}} centerContent={true}><LocationScatterplot filter={filter} /></CardComponent>
          </Box>
        </DashboardContent>
      </DashboardLayout>
      <FilterDrawer 

      ...
      >
        <DashboardContent pathname={router.pathname} sx={{ backgroundColor: '#f7f7f7' }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <CardComponent title="Heatmap" infoContent='Displays the X and Y coordinates of the player within a customizable bin size mapped against "Seconds Elapsed", FPS, CPU Usage, or RAM Usage. Filterable by GPU.'

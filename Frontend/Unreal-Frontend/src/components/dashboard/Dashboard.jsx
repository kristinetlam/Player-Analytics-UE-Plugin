      ...
      <DashboardLayout defaultSidebarCollapsed slots={{ toolbarActions: () => <ToolbarActions setOpenFilter={setOpenFilter} /> }}>
        <DashboardContent pathname={router.pathname} sx={{ backgroundColor: '#f7f7f7' }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <CardComponent title="Average Load" infoContent="A gauge that displays the average usage in CPU or RAM, to a maximum of 100% and 16 GB respectively." sx={{ flex: '1 1 300px', maxWidth: '360px', minWidth: '300px', maxHeight: '400px', display: 'flex', flexDirection: 'column' }} moveTitleUp={true} marginBottom={false} centerContent={true} fixed={true}><Box sx={{ mt: '-40px' }}><LoadGauge filter={filter}/></Box></CardComponent>

      ...
      >
        <DashboardContent pathname={router.pathname} sx={{ backgroundColor: '#f7f7f7' }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            <CardComponent title="Average FPS" infoContent="A calcuation showing the average FPS across all player sessions over the past 30 days. Each player’s FPS is averaged per session, then aggregated into an overall average. The percent comparison analyzes how much of an increase or decrease has occured since last month. If a date is selected, then it will calculate based on T-1 months." sx={{ flex: '1 1 300px', maxWidth: '300px', minWidth: '300px', minHeight: '200px', maxHeight: '300px', display: 'flex', flexDirection: 'column' }} moveTitleUp={true} marginBottom={false} centerContent={true} fixed={true}><AverageFPS filter={filter} /></CardComponent>
